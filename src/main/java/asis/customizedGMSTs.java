...
public class customizedGMSTs {
    ...
    private ASISPatcherConfig asis;
    private TweakIniList tweakInis;

    public customizedGMSTs() {
    }

    public void runCustomizedGMSTs(ASISPatcherConfig asis) {
...
//            {
            switch (startingChar) {
                ...
                case 'b':
                case 'B':
                    gmstToAdd.add(new GMST(BoolSetting.valueOf(currentGMSTName), Boolean.parseBoolean(currentGMSTValue)));
                    break;
                //case Integer
                case 'i':
                case 'I':
                    gmstToAdd.add(new GMST(IntSetting.valueOf(currentGMSTName), Integer.parseInt(currentGMSTValue)));
                    break;
                //case String
                case 's':
                case 'S':
                    //case Float
                    gmstToAdd.add(new GMST(StringSetting.valueOf(currentGMSTName), currentGMSTValue));
                    break;
                case 'f':
                case 'F':
                    gmstToAdd.add(new GMST(FloatSetting.valueOf(currentGMSTName), Float.parseFloat(currentGMSTValue)));
                    break;
                //Just in case
                default:
...
//            }// Close if
    ...
    private enum IniSection {
        ...
        private final IniDataFormat format;
