...
public class IncreasedSpawnsModule extends Framework_Module_Abstract {
    ...
    private static final String thisIniName = "IncreasedSpawns.ini";
    ...
    public IncreasedSpawnsModule(Ini ini) throws IOException {
        ...
        npcsToGetIncreasedSpawns.addExclusion(new SelectionSet(ini.get("MODEXCLUSIONS"), new Matcher.ModContains()));
...
//            spawnweight[0] = ASIS.save.getFloat(ASISSaveFile.GUISettings.ISSPAWN0WEIGHT);
            ...
            Mod asisDep = SPDatabase.getMod(new ModListing("ASIS-Dependency", false));

            FormID uniqueFaction = new FormID("000800", asisDep.getInfo());
            GLOB intSpawnsEnabledGLOB = (GLOB) merger.getMajor("ASISIntSpawns", GRUP_TYPE.GLOB);
            intSpawnsEnabledGLOB.setValue(asis.saveFile().getBool(ASISSaveFile.GUISettings.ISUSEINTERIORSPAWNS));
            ...
            intSpawnsReducedGLOB.setValue(Float.parseFloat(asis.saveFile().getStr(ASISSaveFile.GUISettings.ISREDUCEDINTERIORSPAWNS)));
