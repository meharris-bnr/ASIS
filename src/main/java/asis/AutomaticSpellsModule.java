...
public class AutomaticSpellsModule extends Framework_Module_Abstract {
    ...
    private static final String thisIniName = "AutomaticSpells.ini";
    ...
    private static final String effectKYWDPrefixes = "EffectKeywordPrefixes";

    private static final String SPELLEXCLUSIONSCONTAINS = "SPELLEXCLUSIONSCONTAINS";
    private static final String SPELLEXCLUSIONSSTARTSWITH = "SPELLEXCLUSIONSSTARTSWITH";

    private static final String spellModInclusions = "spellModInclusions";

    private final Set<String> effectPrefixes = new HashSet<>();
    private Mod merger;

    public AutomaticSpellsModule(Ini ini) throws IOException {
        ...
        npcsToGetSpells.addExclusion(new SelectionSet(ini.get("MODEXCLUSIONS"), new Matcher.ModContains()));
        ...
        spellsToDistribute.addExclusion(new SelectionSet(ini.get("MODEXCLUSIONS"), new Matcher.ModContains()));
    ...
    public void runModuleChanges(ASISPatcherConfig asis) {
        ...
        addSpellsToNPCs(spellsMap, npcsMap, asis);
    }
    ...
    private void addSpellsToNPCs(Map<SPEL, SpellInfo> spellsMap, Map<NPC_, NPCInfo> npcsMap, ASISPatcherConfig asis) {
        try {
...
//                        }
    ...
    private static class SpellInfo {
        ...
        private SpellInfo(SPEL theSpell, Skill mainSkill, MGEF mainEffect, Map<Skill, Integer> neededSkills) {
            ...
            this.equipslot = theSpell.getEquipSlot();
        }
