...
public class INI_asis {
    ...
    private final Map<IniSectionHead, Collection<IniData>> iniMap = new TreeMap<>();
    private final Collection<IniSectionHead> sections = new ArrayList<>();
    ...
    public void readData() throws IOException {
        ...
        while ((currentLine = iniReader.readLine()) != null) {
            ...
            if (containsHeader(currentLine)) {
                ...
                foundType = true;
                iniMap.put(currentSection, new ArrayList<>());
    ...
    public Collection<String> getIniSections() {
        ...
        for (Object iniSectionType : iniSectionTypes) {
            iniSectionsToReturn.add((String) iniSectionType);
        }
